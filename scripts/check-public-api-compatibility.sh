...
fail "the canonical v0.6.2 public surface changed. An accepted change requires an explicit entry in Docs/recovery-design-2026-08-20.md and a baseline update."
