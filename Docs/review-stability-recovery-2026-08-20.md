...
| Wave 3B / #106 runtime close | Exact 12 production + 10 test/gate allowed paths | Store-owned work/aggregate + replaceable AppServer handle + app-lifetime sequential MCP-lease owner + zero-sibling replacement + public close | Pending exact 3A checkpoint; combined 3A+B exact-base merge gate required |
