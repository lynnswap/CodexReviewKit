...
- Current integration anchor: `7fa1a0a` (PR #155 merged).
- Merged successors are PRs #114, #115, #116, #122–#125, #127, #128,
  #130–#132, #134–#140, and #142–#155. They provide the completed viewport,
...
| Admission-less start wrapper cleanup | merged | #155 / `7fa1a0a` |
| Typed recovery source preparation | current slice | — |
| Typed recovery destination staging | pending | — |
| Store typed recovery receipt consumption | pending | — |
