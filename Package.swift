...
let package = Package(
    ...
    dependencies: [
        ...
        // CodexKit has no tagged releases yet; pin the reviewed native-login revision.
        .package(url: "https://github.com/lynnswap/CodexKit.git", revision: "ca8a3835b00a9e32cac7d83b7b0fd2507e9ff5f1"),
    ],
    targets: [
        .target(
            name: "CodexReviewKit",
